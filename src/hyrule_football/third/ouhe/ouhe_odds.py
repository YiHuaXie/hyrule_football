...
class OHAsiaOdds(BaseModel):
    ...
    matchId: Annotated[str, Field(..., description="比赛ID")]
    cid: Annotated[str, Field(..., description="博彩公司ID")]
    initBet: Annotated[str, Field(..., description="亚盘-初始盘口")]
    initOddsWin: Annotated[str, Field(..., description="亚盘-初始主胜赔率")]
    initOddsLose: Annotated[str, Field(..., description="亚盘-初始客胜赔率")]
    initReturnRates: Annotated[str, Field(..., description="亚盘-初始返还率")]
    nowBet: Annotated[str, Field(..., description="亚盘-即时盘口")]
    nowOddsWin: Annotated[str, Field(..., description="亚盘-即时主胜赔率")]
    nowOddsLose: Annotated[str, Field(..., description="亚盘-即时客胜赔率")]
    nowReturnRates: Annotated[str, Field(..., description="亚盘即时初始返还率")]
    ...
    def initWaterLevel(self) -> str:
        """标准化初始水位数据，返回低/中/高"""
        return water_level_standadrd_str(self.initReturnRates)
    
    @property
    def nowWaterLevel(self) -> str:
        """标准化即时水位数据，返回低/中/高"""
        return water_level_standadrd_str(self.nowReturnRates)
